	...
	<body>
	    ...
	    <div class="container company col-md-offset-2 col-md-8">
			<div class="events-tittle">
	        	<a name="title"><h3 class="letter-title">Golosinas</h3></a>
	      	</div>
	      	<div class="content company row">
	      		<div class="">
	      			<p><span class="strong">Laboratorio Fleibor srl.</span> ha ido desarrollando año tras año su extensa línea de 
					esencias y colorantes, adaptándose a los paladares mas exigentes, el de los chicos. Nuestra línea de aromas 
					permite disfrutar de las exquisiteces que brinda la naturaleza. Gracias a ella Laboratorio Fleibor ha obtenido 
					la línea mas completa de tonos para que usted pueda disfrutar y colorear su vida.</p>
					<p>Los <span class="strong">productos</span> que ofrecemos <span class="strong">relacionado con golosinas</span> son los siguientes: </p>
	      		</div>
	      	</div>
			<br>
			...
			<div class="panel-heading">Listado de Escencias</div>
				...
				<tbody>
				<tr>
				<td><strong>ESENCIA</strong> ALMENDRAS </td>
