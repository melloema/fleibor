	...
	<body>
	    ...
	    <div class="container company col-md-offset-2 col-md-8">
			<div class="events-tittle">
	        	<a name="title"><h3 class="letter-title">Helados</h3></a>
	      	</div>
	      	<div class="content company row">
	      		<div class="">
	      			<p><span class="strong">Laboratorio fleibor</span> ofrece una extensa gama de colores y esencias para la elaboración de helados. 
					El postre preferido en el verano debe reflejar en el paladar frescura y un sabor agradable. 
					Gracias a la diversidad de aromas que producimos podrá obtener un producto de excelente calidad y un sabor pleno.</p>
					<p>Los productos que ofrecemos relacionado con <span class="strong">helados</span> son los siguientes:</p>
	      		</div>
	      	</div>
			<br>
			...
			<div class="panel-heading">Listado de Escencias</div>
				...
				<tr class="panel-footer">
				<td><strong>ESENCIA</strong> PANETTONE </td>
				...
				<tr class="panel-footer">
				<td><strong>ESENCIA</strong> PISTACHO</td>
				<td><strong>ESENCIA</strong> COGÑAC</td>
				</tr>
				<tr>
				<td><strong>ESENCIA </strong> CREMA AMERICANA</td>
				...
				<tr>
				<td><strong>ESENCIA </strong> SAMBAYON</td>
