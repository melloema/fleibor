	    ...
	    <div class="container company col-md-offset-2 col-md-8">
			<div class="events-tittle">
	      	...
	      	<div class="content company row">
	      		<div class="">
	      			<p>Las técnicas del trabajo en porcelana en frío se han ido modificando, debido a eso 
					todos los años desarrollamos nuevos productos para perfeccionar las técnicas y que usted
					pueda obtener trabajos mas finos. </p>
					<br/>
	      			<p>Nuestros aditivos disponibles para usted son los siguientes:</p>
					<br/>
					<p>NUEVA LINEA: FULGORADOS Pigmento en polvo con brillo metálico,
					...
					<p> Tonos: Amarillo, Azabache, Azul, Blanco, Cobre, Marrón, Naranja, Rojo, Verde, Violeta.</p>
					<br/>
					<p>NOVEDAD! FULGOR MÁGICO Novedoso producto hecho para dar un mágico brillo a superficies 
					...
					<p>Tonos: Blanco, Celeste, Cobre, Dorado, Rojo, Verde y Violeta.</p>
					<br/>
					<p>NOVEDAD! PERFUME PARA PORCELANA EN FRÍO Aplicando una o dos gotas del 
					producto en la figura o modelo ya terminado se logra que adquiera mayor realismo. Ver Listado</p>
					<br/>
					<p>NOVEDAD! COLORANTES PARA AERÓGRAFO Ahora puede pintar su trabajo en azúcar o 
					...
					<p>Colores: Amarillo, Azul, Azul O, Marrón, Naranja, Negro, Rojo A, Rojo E, Rojo P, Rosa, Verde y Violeta.</p>
					<p>Encuentre en este producto los cálidos tonos que su artesanía merece. </p>
					<br/>
					<p>COLORANTES EN PASTA Ponemos a su alcance la línea más extensa del mercado de 
					...
					Lanzamiento de nuevos colores: <a href="#">Ver Colores</a></p>
					<br/>
					<p>PORCE CLEAR blanquea la pasta de porcelana y aumenta su transparencia.
					Se agrega a la pasta de porcelana lista para usar en una proporción de 2 gotas por cada 100g.</p>
					<br/>
					<p>BRILLOS (simil Glitter) las ventajas de polvos mas finos y brillantes, 
					...
					<br/>
					<p>DILUYENTE COL. PORCELANA  </p>
					<br/>
					<p>ILUMINADOR polvo superfino para lograr reflejos metálicos. De esta 
					...
					<br/>
					<p>DILIUM diluyente ecológico para oleos. Reemplaza en su uso a la esencia de 
					trementina, posee una fragancia cítrica y barre eficazmente los oleos. Secado rápido. </p>
					<br/>
					<p>POLVOS PARA PÉTALOS para lograr colores esfumados se aplican en seco con un pincel o con los dedos.</p>
					<p>Para lograr colores plenos, se aplican con un pincel mojado previamente en alcohol 
					logrando un secado instantaneo.Producto no comestible y no toxico. Listado de Polvos para petalos</p>
					<br/>
	      		</div>
	      	</div>
			<br>
