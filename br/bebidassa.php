	...
	<body>
	    ...
	    <div class="container company col-md-offset-2 col-md-8">
			<div class="events-tittle">
	        	<a name="title"><h3 class="letter-title">Bebidas não alcoólicas</h3></a>
	      	</div>
	      	<div class="content company row">
	      		<div class="">
	      			<p>Misturando <span class="strong">essências e corantes</span> fleibor você pode conseguir bebidas dede <span class="strong">ótima qualidade</span>obtendo diferentes sabores de frutas que você possa imaginar.</p>
					<p>Em sua elaboração de <span class="strong">sucos, refrigerantes e vitaminas</span> você pode inovar usando nossos aditivos que oferecerão originalidade a seu produto.</p>
					<p><span class="strong">Produtos</span> para <span class="strong">bebidas não alcoólicas:</span></p>
	      		</div>
	      	</div>
			<br>
			...
			<div class="panel-heading">Lista de Essências</div>
				...
				<td><strong>ESSÊNCIAS</strong> TUTTI FRUTI</td>
				</tr>
				<tr>
