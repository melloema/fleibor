	...
	<body>
	    ...
	    <div class="container company col-md-offset-2 col-md-8">
			<div class="events-tittle">
	        	<a name="title"><h3 class="letter-title">Bebidas alcoólicas</h3></a>
	      	</div>
	      	<div class="content company row">
	      		<div class="">
	      			<p>A elaboração de <span class="strong">bebidas alcoólicas</span> é muito antiga e com o tempo foi aperfeiçoando-se e industrializando a produção das mesmas. Laboratório  <span class="strong">fleibor</span> acompanha este desenvolvimento contribuindo com suas <span class="strong">essências e corantes</span> que são os ingredientes certos deste processo. Dia a dia nos esforçamos para melhorar nossros produtos e aumentar sua satisfação.</p>
					<p><span class="strong">Produtos </span> para <span class="strong">bebidas alcoólicas:</span></p>
	      		</div>
	      	</div>
			<br>
