	...
	<body>
	    ...
	    <div class="container company col-md-offset-2 col-md-8">
			<div class="events-tittle">
	        	<a name="title"><h3 class="letter-title">Guloseimas</h3></a>
	      	</div>
	      	<div class="content company row">
	      		<div class="">
	      			<p><span class="strong">Laboratorio Fleibor</span> vem desenvolvendo ano trás ano sua extensa linha de essências e corantes, adaptando-se aos paladares mais exigentes e também das crianças. Nossa linha de aromas permite aproveitar as delícias que nos oferece a natureza. Graças a ela Laboratório Fleibor obteve a linha mais completa de tons para que você possa desfrutar e colorir sua vida.</p>
					<p>Os <span class="strong">produtos</span> que oferecidos para <span class="strong">guloseinas</span> são os seguintes:</p>
	      		</div>
	      	</div>
			<br>
			...
			<div class="panel-heading">Lista de Essências</div>
				...
				<tr>
				<td><strong>ESSÊNCIAS</strong> COLA</td>
				...
				<tr class="panel-footer">
				<td><strong>ESSÊNCIAS</strong> EUCALIPTO</td>
				</tr>
				</tbody>
				</table>
			...
			<div class="panel panel-primary ">
			<div class="panel-heading">Listado de Corantes L&iacute;quidos</div>
				<table class="table"> 
